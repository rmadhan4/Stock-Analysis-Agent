...
def run_stock_analysis_agent(ticker):
    ...
    # Instantiate Free-Tier Gemini Model (using gemini-1.5-flash for speed/costs)
...
"""
    ...
    print(f"🧠 Processing institutional analysis report via Gemini...")
    ...
    # ---- NEW RICH COLORFUL CARD FORMATTING ----
    ...
    # 1. Clear terminal noise and create a header banner
    console.print("\n")
    console.print(
        Panel(
    ...
    # 2. Render the LLM's Markdown output inside a styled Card Panel
    # Gemini naturally writes in markdown, which Rich turns into beautiful terminal text.
    report_card = Panel(
    ...
    # 3. Print the final dashboard card
